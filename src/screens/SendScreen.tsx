import { View,  SafeAreaView, TouchableOpacity, Animated, Platform, StatusBar } from 'react-native'
    ...
    setNearbyDevices((prevDevices : any) => {
      ...
      if (!deviceExists) {
        const newDevice = {
          ...
          position: getRandomPosition(150, prevDevices?.map((d:any) => d.position), 50),
      ...
      return prevDevices;
    }); // This parenthesis and semicolon were missing.
  }); // This parenthesis and semicolon were missing.
};
...
//       setNearbyDevices((prevDevices : any) => [...prevDevices, newDevice]);
